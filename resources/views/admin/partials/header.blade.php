    ...
    <div class="sidebar bg-black">
      ...
      <nav class="mt-2">
       <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">          <!-- Add icons to the links using the .nav-icon class
               ...
               <li class="nav-item">
                <a href="{{route('Admin.InterestIndex')}}" class="nav-link">
                 <p>Interests</p>
                </a>

               {{--<li class="nav-item">
                <a href="{{route('getProfile')}}" class="nav-link">
                 <p>My Profile</p>
                </a>
              </li>
                <li class="nav-item">
                <a href="{{ route('terms-and-conditions') }}" class="nav-link">
